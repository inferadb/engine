...
**Location**: [`crates/inferadb-engine-core/src/evaluator.rs`](../crates/inferadb-engine-core/src/evaluator.rs)
...
**Location**: [`crates/inferadb-engine-core/src/graph.rs`](../crates/inferadb-engine-core/src/graph.rs)
...
**Unit Tests** ([`crates/inferadb-engine-core/src/evaluator.rs`](../crates/inferadb-engine-core/src/evaluator.rs)):
...
**Integration Tests** ([`crates/inferadb-engine-core/tests/`](../crates/inferadb-engine-core/tests/)):

- Document management scenario
- Organization hierarchy scenario
- Role-based access control scenario

**Benchmarks** ([`crates/inferadb-engine-core/benches/evaluator.rs`](../crates/inferadb-engine-core/benches/evaluator.rs)):
