...
cargo test --package infera-config --features azure-secrets test_azure_secrets_provider -- --ignored --nocapture
```
...
cargo test -p infera-config --features azure-secrets --lib azure
