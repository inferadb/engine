...
use inferadb_engine_types::{RelationshipKey, Revision};
...
///
/// ```ignore
/// use inferadb_engine_core::graph::has_direct_relationship;
...
/// }
/// # Ok::<(), inferadb_engine_core::EvalError>(())
/// # };
/// ```
...
///
/// ```ignore
/// use inferadb_engine_core::graph::get_users_with_relation;
/// use inferadb_engine_types::Revision;
///
/// # async {
/// let vault_id = 1i64;
...
///
/// ```ignore
/// use inferadb_engine_core::graph::prefetch_users_batch;
/// use inferadb_engine_types::Revision;
///
/// # async {
/// let vault_id = 1i64;
