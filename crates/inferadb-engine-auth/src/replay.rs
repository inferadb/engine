...
//!
//! ```ignore
//! use inferadb_engine_auth::replay::{ReplayProtection, InMemoryReplayProtection};
//!
...
///
/// ```ignore
/// use inferadb_engine_auth::replay::RedisReplayProtection;
///
...
///
/// ```ignore
/// use inferadb_engine_auth::replay::InMemoryReplayProtection;
///
/// let replay = InMemoryReplayProtection::new();
/// let is_new = replay.check_and_mark("jti-123", 1700000000).await?;
/// ```
